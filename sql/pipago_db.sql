...
(1000, 'admin@pipago.com', '86dd76e74017a9a4856c5c6d6937e471fa6f80f41b720428c0a73610d7dbbe75');

-- --------------------------------------------------------

--
-- Table structure for table `adminsalt`
--

CREATE TABLE `adminsalt` (
  `sid` int(11) NOT NULL COMMENT 'salt id',
  `aid` int(11) NOT NULL COMMENT 'admin id',
  `salt` varchar(32) NOT NULL COMMENT 'salt'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `adminsalt`
--

INSERT INTO `adminsalt` (`sid`, `aid`, `salt`) VALUES
(1, 1000, '65c53cd5c62fec1766ad6bef6aac1253');
...
(1001, 'firaol', 'wakuma', '2022-04-21', 'addis abeba ', 'firaol@email.com', '49620aa0869973f5584dbdefc5c50b23646cab16e3f16a5cbe27cfd1a81d55d7', 'male', 'is', '2023-08-15 11:40:15', '2022-04-25 14:47:39', '');
...
INSERT INTO `usersalt` (`sid`, `uid`, `salt`) VALUES
(1, 1001, '00e7a17d32f03da112294fbed42f3c4c');
...
--
-- AUTO_INCREMENT for table `adminsalt`
--
ALTER TABLE `adminsalt`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'salt id', AUTO_INCREMENT=2;
...
--
-- Constraints for table `adminsalt`
--
ALTER TABLE `adminsalt`
  ADD CONSTRAINT `adminsalt_ibfk_1` FOREIGN KEY (`aid`) REFERENCES `admin` (`admin_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `usersalt`
--
ALTER TABLE `usersalt`
  ADD CONSTRAINT `usersalt_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
